...
var swear_words_arr=new Array("nigg3r", "nigg4h", "nigga", "niggah", "niggas", "niggaz", "nigger", "niggers", "niglet", "nazi", "ching chong", "ch1ng ch0ng", "dyke");
...
<h1  style="text-align: center;
    margin-top: 2em;">hey bro racism isn't very nice, so it aint gon be added gng \nbtw, the following illegal words were found:</h1> <p>${alert_text}</p>`   
  // Fade message in
